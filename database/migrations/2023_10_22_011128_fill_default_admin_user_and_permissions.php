...
class FillDefaultAdminUserAndPermissions extends Migration
{
    ...
    {
        $this->guardName = config('sell-first-roles.defaults.guard');
        ...
        $defaultPermissions = collect(config('sell-first-roles.defaults.permissions.system'));
        ...
        $this->roles = [
            [
                'name' => config('sell-first-roles.roles.administrator'),
                'guard_name' => $this->guardName,
            ...
            [
                'name' => config('sell-first-roles.roles.manager'),
                'guard_name' => $this->guardName,
                'permissions' => [],
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ...
            [
                'name' => config('sell-first-roles.roles.user'),
                'guard_name' => $this->guardName,
                'permissions' => [],
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
